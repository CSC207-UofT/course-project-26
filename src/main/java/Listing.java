...
public class Listing {
    ...
    private HashMap<Book.Book, Integer> listBooks; // key is a Book, value is product number
    ...
    public HashMap<Book.Book, Integer> getListingBook() { return this.listBooks; }

    public String getListingStatus() { return this.status; }

    public void setListingStatus(String status) { this.status = status; }

    public void addBookToListing(Book.Book book, Integer quantity) {
        this.listBooks.put(book, quantity);
    }

    public void removeBookFromListing(Book.Book book, Integer quantity) {
