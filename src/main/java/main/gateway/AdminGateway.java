...
public class AdminGateway extends Gateway {
    ...
    public void saveadmintoFile(ArrayList adminList){
        try
        {
            FileOutputStream fos = new FileOutputStream("src/main/java/Main.ConsoleUI.Database/Admin.ser");
    ...
    public ArrayList readadminfromFile() {
        ...
        try {
            File file = new File("src/main/java/Main.ConsoleUI.Database/Admin.ser");
